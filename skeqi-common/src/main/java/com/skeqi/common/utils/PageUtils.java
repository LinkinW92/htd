...
import com.skeqi.common.utils.sql.SqlUtil;
...
public class PageUtils {
	...
	public static <T> TableDataInfo<T> buildDataInfo(IPage<T> page) {
		TableDataInfo<T> rspData = new TableDataInfo<>();
		rspData.setCode(HttpStatus.HTTP_OK);
		rspData.setMsg("查询成功");
		rspData.setRows(page.getRecords());
	...
	public static <T> TableDataInfo<T> buildDataInfo(List<T> list,Integer total) {
		TableDataInfo<T> rspData = new TableDataInfo<>();
		rspData.setCode(HttpStatus.HTTP_OK);
		rspData.setMsg("查询成功");
		rspData.setRows(list);
...
//	public static <T> void buildPageBo(T obj){
//
//	}
