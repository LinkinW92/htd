...
public class Rjson {
	...
	public static TableDataInfo<Map<String, Object>> getPageInfoByFormatTime(List<Map<String, Object>> list){
	...
	public static Map<String, Object> reservingDifferences(Map<String, Object> nMap, Map<String, Object> oMap) throws Exception{
		...
		map.put("nMap", JSONUtil.toJsonStr(nMap));
		map.put("oMap", JSONUtil.toJsonStr(oldMap));
		return map;
	}
