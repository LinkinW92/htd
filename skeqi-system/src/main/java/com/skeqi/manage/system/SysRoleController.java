...
public class SysRoleController extends BaseController {
	...
	public AjaxResult batchUpdateRole(@RequestBody String jsonStr) {
		List<SysUserRole> userList = JSONUtil.parseArray(jsonStr).toList(SysUserRole.class);
		return AjaxResult.success(roleService.batchUpdateRole(userList));
	}

	/**
	 * 根据用户ID查询用户权限id
	 */
	@PostMapping("/findSysUserRole/{userId}")
	public Long findSysUserRole(@PathVariable(value = "userId") Long userId) {
		return roleService.findSysUserRole(userId);
	}
