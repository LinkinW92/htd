...
/**
 * 总账管理参数-账簿参数视图对象 t_bd_book_param
 *
 * @author toms
 * @date 2021-07-09
 */
@Data
@ApiModel("总账管理参数-账簿参数视图对象")
public class TBdBookParamVo {
