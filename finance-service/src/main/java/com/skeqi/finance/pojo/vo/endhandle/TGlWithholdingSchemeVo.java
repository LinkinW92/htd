...
/**
 * 凭证预提视图对象 t_gl_withholding_scheme
 *
 * @author toms
 * @date 2021-07-27
 */
@Data
@ApiModel("凭证预提视图对象")
public class TGlWithholdingSchemeVo {
	...
	List<TGlWithholdingAcctVo> acctVos;

	@ApiModelProperty("转入科目")
	List<TGlWithholdingInacctVo> inacctVos;

	@ApiModelProperty("预提期间")
	List<TGlWithholdingPeriodVo> periodVos;
}
