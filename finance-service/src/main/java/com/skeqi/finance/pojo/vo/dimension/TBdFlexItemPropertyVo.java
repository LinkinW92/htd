...
/**
 * 核算维度视图对象 t_bd_flex_item_property
 *
 * @author toms
 * @date 2021-07-09
 */
@Data
@ApiModel("核算维度视图对象")
public class TBdFlexItemPropertyVo {
	...
	/** 名称 */
	@Excel(name = "维度来源名称")
	@ApiModelProperty("维度来源名称")
	private String fDimensionSourceName;

	/** 编码 */
	@Excel(name = "编码")
	@ApiModelProperty("编码")
	private String fDimensionSourceNumber;
	//endregion
