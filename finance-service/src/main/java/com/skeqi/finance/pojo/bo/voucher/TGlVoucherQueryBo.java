...
@ApiModel("凭证录入主分页查询对象")
public class TGlVoucherQueryBo extends BaseEntity {
	 ...
	 */
	@ApiModelProperty("凭证来源：1、一般凭证：手工录入2、业务系统凭证：由业务系统单据生成3、机制凭证：总账系统通过凭证模板系统自动生成")
