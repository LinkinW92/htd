...
import com.skeqi.common.core.domain.TreeSelect;
...
import com.skeqi.manage.domain.SysRoleMenu;
import com.skeqi.manage.domain.vo.MetaVo;
import com.skeqi.manage.domain.vo.RouterVo;
import com.skeqi.manage.mapper.SysMenuMapper;
import com.skeqi.manage.mapper.SysRoleMapper;
import com.skeqi.manage.mapper.SysRoleMenuMapper;
...
public class SysMenuServiceImpl extends ServicePlusImpl<SysMenuMapper, SysMenu> implements ISysMenuService {
    ...
    public List<SysMenu> getChildPerms(List<SysMenu> list, int parentId) {
		...
		for (SysMenu t : list) {
			...
			//System.out.println("parentId"+parentId+"===="+t.getParentId());
