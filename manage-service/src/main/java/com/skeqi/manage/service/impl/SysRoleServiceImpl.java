...
import com.skeqi.common.utils.spring.SpringUtils;
import com.skeqi.manage.domain.SysRoleDept;
...
public class SysRoleServiceImpl extends ServicePlusImpl<SysRoleMapper, SysRole> implements ISysRoleService {
	...
	@Override
	@Transactional
	public int batchUpdateRole(List<SysUserRole> userList) {
		return userRoleMapper.updateStatus(userList);
	}
