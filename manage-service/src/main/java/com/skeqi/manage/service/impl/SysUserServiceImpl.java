...
import com.skeqi.common.annotation.DataScope;
...
import com.skeqi.manage.domain.SysPost;
import com.skeqi.manage.domain.SysUserPost;
import com.skeqi.manage.domain.SysUserRole;
import com.skeqi.manage.mapper.*;
import com.skeqi.manage.service.ISysConfigService;
...
public class SysUserServiceImpl extends ServicePlusImpl<SysUserMapper, SysUser> implements ISysUserService {
	...
	public List<SysUser> findSysUserList(String supplierCode) {
		...
		userLambdaQueryWrapper.eq(SysUser::getSupplierCode, supplierCode);
     ...
     */
    @Override
    public boolean updateUserStatusBySupplierCode(String supplierCode, String status) {
		return baseMapper.update(null,
			new LambdaUpdateWrapper<SysUser>()
				.set(SysUser::getStatus,status)
				.eq(SysUser::getSupplierCode,supplierCode)) > 0;
    }
