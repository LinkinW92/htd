...
public class CSrmAssessRecordHReq {
     ...
     * 建档开始时间
     */
    private String filingStart;


    /**
     * 建档截止时间
     */
    private String filingStop;
     ...
     * 档案行数据
     */
    private List<CSrmAssessRecordRReq> reqList;
    ...
    public List<CSrmAssessRecordRReq> getReqList() {
        return reqList;
    }

    public void setReqList(List<CSrmAssessRecordRReq> reqList) {
    ...
    public String getFilingStart() {
        return filingStart;
    }

    public void setFilingStart(String filingStart) {
        this.filingStart = filingStart;
    }

    public String getFilingStop() {
        return filingStop;
    }

    public void setFilingStop(String filingStop) {
        this.filingStop = filingStop;
    }
    ...
    public String toString() {
        return "CSrmAssessRecordHReq{" +
                ...
                ", filingStart='" + filingStart + '\'' +
                ", filingStop='" + filingStop + '\'' +
