...
/**
    * 供应商变更记录表
    */
public class CSrmSupplierChangeRecordRsp {
...
//    private String position;
     ...
     * 联系人行数据
     */
    private List<CSrmLinkmanChangeRecordRsp> linkManList;
...
//    private String retainedProfits;
     ...
     * 财务行数据
     */
    private List<CSrmFinanceChangeRecordRsp> financeList;
...
//    private String collectorTelephoneNumber;
     ...
     * 银行\交易行数据
     */
    private List<CSrmBankChangeRecordRsp> bankList;
...
//------------------------------------------其他参数--------------------------------------------------------------------
    ...
    public List<CSrmLinkmanChangeRecordRsp> getLinkManList() {
        return linkManList;
    }

    public void setLinkManList(List<CSrmLinkmanChangeRecordRsp> linkManList) {
        this.linkManList = linkManList;
    }

    public List<CSrmFinanceChangeRecordRsp> getFinanceList() {
        return financeList;
    }

    public void setFinanceList(List<CSrmFinanceChangeRecordRsp> financeList) {
        this.financeList = financeList;
    }

    public List<CSrmBankChangeRecordRsp> getBankList() {
        return bankList;
    }

    public void setBankList(List<CSrmBankChangeRecordRsp> bankList) {
