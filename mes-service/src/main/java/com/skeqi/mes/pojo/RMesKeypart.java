...
public class RMesKeypart {
	...
	public RMesKeypart(Integer id, Date dt, Integer transfer, Integer keypartMode, String st, String sn, String wid,
			String tid, String secondNum, Integer keypartId, String keypartName, String keypartPn, String keypartNum,
			String keypartModule, String keypartReworkFg, String keypartReworkSt, Integer materialId,
	...
	public String toString() {
		return "RMesKeypart [id=" + id + ", dt=" + dt + ", transfer=" + transfer + ", keypartMode=" + keypartMode
