 ...
 * @date 2021-08-24
 */
public interface WmsPurchaseReturnDao {
	 ...
	 * @return
	 */
	public List<JSONObject> findPurchaseOrderH(@Param("orderNumber")String orderNumber);
	 ...
	 * @return
	 */
	public List<JSONObject> findPurchaseOrderR(@Param("orderNumber")String orderNumber);
