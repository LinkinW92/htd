 ...
 */
@RestController
@RequestMapping("/api/equipment/checkData")
public class CheckDataController {

	@Autowired
	CheckDataService service;
	...
	public Rjson list(HttpServletRequest request) {
		try {
			...
			String checkPerson = EqualsUtil.string(request, "checkPerson", "点检人", false);
	...
	public Rjson add(HttpServletRequest request) {
		try {
			...
			String dt = EqualsUtil.string(request, "dt", "点检时间", true);
			String checkPerson = EqualsUtil.string(request, "checkPerson", "点检人", false);
	...
	public Rjson update(HttpServletRequest request) {
		try {
			...
			String dt = EqualsUtil.string(request, "dt", "点检时间", false);
			String checkPerson = EqualsUtil.string(request, "checkPerson", "点检人", false);
			String remarks = EqualsUtil.string(request, "remarks", "备注", false);
