 ...
 */
@RestController
@RequestMapping("/api/EquipmentInformationSpotCheck")
public class EquipmentInformationSpotCheckController {

	@Autowired
	EquipmentInformationSpotCheckService service;
	...
	public Rjson add(HttpServletRequest request) {
		try {
			...
			int spotCheckCycle = EqualsUtil.integer(request, "spotCheckCycle", "点检周期", true);
