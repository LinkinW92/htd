 ...
 */
@RestController
@RequestMapping("/api/equipment/equipmentMaintainItems")
public class EquipmentMaintainItemsController {

	@Autowired
	EquipmentMaintainItemsService service;
	...
	public Rjson add(HttpServletRequest request) {
		try {
			String item = EqualsUtil.string(request, "item", "保养项", true);
