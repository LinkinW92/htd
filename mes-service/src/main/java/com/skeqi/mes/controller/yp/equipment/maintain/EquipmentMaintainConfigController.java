...
import com.skeqi.mes.service.yp.equipment.maintain.EquipmentMaintainConfigService;
 ...
 */
@RestController
@RequestMapping("/api/equipment/equipmentMaintainConfig")
public class EquipmentMaintainConfigController {

	@Autowired
	EquipmentMaintainConfigService service;
	...
	public Rjson list(HttpServletRequest request) {
		try {
			...
			String name = EqualsUtil.string(request, "name", "保养名", false);
	...
	public Rjson add(HttpServletRequest request) {
		try {
			String name = EqualsUtil.string(request, "name", "保养名 ", true);
			String code = EqualsUtil.string(request, "code", "保养编号 ", true);
			...
			String itemList = EqualsUtil.string(request, "itemList", "保养项", false);
